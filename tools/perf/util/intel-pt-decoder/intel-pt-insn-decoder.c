...
int intel_pt_insn_type(enum intel_pt_insn_op op)
{
	...
	case INTEL_PT_OP_CALL:
		return PERF_FLAG_BRANCH | PERF_FLAG_CALL;
	case INTEL_PT_OP_RET:
		return PERF_FLAG_BRANCH | PERF_FLAG_RETURN;
	case INTEL_PT_OP_JCC:
		return PERF_FLAG_BRANCH | PERF_FLAG_CONDITIONAL;
	case INTEL_PT_OP_JMP:
		return PERF_FLAG_BRANCH;
	...
	case INTEL_PT_OP_INT:
		return PERF_FLAG_BRANCH | PERF_FLAG_CALL | PERF_FLAG_INTERRUPT;
	case INTEL_PT_OP_SYSCALL:
		return PERF_FLAG_BRANCH | PERF_FLAG_CALL | PERF_FLAG_SYSCALLRET;
